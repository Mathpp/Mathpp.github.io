...
var configure = function () {
    Module._Configure(cal, config[0], config[1], config[2].charCodeAt(0), config[3].charCodeAt(0), config[4].charCodeAt(0));
};
var initCalc = function () {
    if (!cal) {
        cal = Module._CreateCalculator();
        configure();
    }
};
var cal = null;
var invoke = function (value) {
    initCalc();
    var buf = Module._malloc((value.length + 1) << 2);
    stringToUTF32(value, buf, (value.length + 1) << 2);
    Module._Invoke(cal, buf);
    Module._free(buf);
...
onmessage = function (e) {
    switch (e.data.type) {
        case "invoke":
            invoke(e.data.expression);
            break;
        case "reset":
            Module._DeleteCalculator(cal);
            cal = null;
            initCalc();
            break;
        case "configure":
        ...
        case "showsteps":
            initCalc();
            Module._ShowSteps(cal);
            break;
        case "hidesteps":
            initCalc();
            Module._HideSteps(cal);
            break;
        default:
            break;
    }
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5379456,
    DYNAMIC_BASE = 5379456,
    DYNAMICTOP_PTR = 136544;
...
var wasmBinaryFile = 'Math+Web.wasm';
...
// {{PRE_LIBRARY}}
  ...
  function _OnDefine(wlabel, wwrite, count) {
          var write = UTF32ToString(wwrite);
          postMessage({ type: "ondefine", label: UTF32ToString(wlabel), formula: "\\formula{" + write.replace(/\t/g,"\\parameter{}") + "}", count: count});
      }

  function _PrintLine(a, b) {
          postMessage({ type: "printline", data: [a, b != 0 ? UTF32ToString(b) : null]});
      }
...
var real__Configure = asm["_Configure"];
asm["_Configure"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__Configure.apply(null, arguments);
};

var real__CreateCalculator = asm["_CreateCalculator"];
asm["_CreateCalculator"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__CreateCalculator.apply(null, arguments);
};

var real__DeleteCalculator = asm["_DeleteCalculator"];
asm["_DeleteCalculator"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__DeleteCalculator.apply(null, arguments);
};

var real__HideSteps = asm["_HideSteps"];
asm["_HideSteps"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__HideSteps.apply(null, arguments);
};

var real__Invoke = asm["_Invoke"];
asm["_Invoke"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__Invoke.apply(null, arguments);
};

var real__ShowSteps = asm["_ShowSteps"];
asm["_ShowSteps"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__ShowSteps.apply(null, arguments);
};
...
var real__sizeofwchar = asm["_sizeofwchar"];
asm["_sizeofwchar"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__sizeofwchar.apply(null, arguments);
};
...
var _Configure = Module["_Configure"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_Configure"].apply(null, arguments)
};

var _CreateCalculator = Module["_CreateCalculator"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_CreateCalculator"].apply(null, arguments)
};

var _DeleteCalculator = Module["_DeleteCalculator"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_DeleteCalculator"].apply(null, arguments)
};

var _HideSteps = Module["_HideSteps"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_HideSteps"].apply(null, arguments)
};

var _Invoke = Module["_Invoke"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_Invoke"].apply(null, arguments)
};

var _ShowSteps = Module["_ShowSteps"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_ShowSteps"].apply(null, arguments)
};
...
var _sizeofwchar = Module["_sizeofwchar"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_sizeofwchar"].apply(null, arguments)
};
